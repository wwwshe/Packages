...
public class DotLabel: UILabel {
    public struct Configuration {
        ...
        public init(
            ...
            inset = UIEdgeInsets(top: 0, left: dotSize + spacing, bottom: 0, right: 0)
            self.color = color
        }
    }
    ...
    extension DotLabel {
        ...
        struct Preview: UIViewRepresentable {
            ...
            func makeUIView(context _: Context) -> DotLabel {
                let label = DotLabel()
                label.text = "콘텐츠입니다"
                return label
            }

            func updateUIView(_: DotLabel, context _: Context) {}
        }
    }
